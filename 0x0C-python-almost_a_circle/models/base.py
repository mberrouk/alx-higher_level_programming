...
class Base:
    ...
    Methods:
        __init__(self, id=None): Class constructor to initialize the object.
    """
    __nb_objects = 0
    ...
    def __init__(self, id=None):
        ...
        Args:
            id (int, optional): If provided, assigns the specified ID to the object.
                               If not provided, increments __nb_objects and assigns the
                               new value to the object's ID.
        """
        if id == None:
            Base.__nb_objects += 1
